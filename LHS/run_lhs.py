...
def create_namelist(samples):
        ...
        util.replace_string_in_file('namelist.input', 'DT_START_YEAR_DT', '2012')
        util.replace_string_in_file('namelist.input', 'DT_START_MONTH_DT', '01')
        util.replace_string_in_file('namelist.input', 'DT_START_DAY_DT', '01')
        ...
        util.replace_string_in_file('namelist.input', 'DT_END_YEAR_DT', '2012')
        util.replace_string_in_file('namelist.input', 'DT_END_MONTH_DT', '01')
        util.replace_string_in_file('namelist.input', 'DT_END_DAY_DT', '01')
        # Go for one hour
